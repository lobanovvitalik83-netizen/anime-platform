...
class Settings(BaseSettings):
    ...
    max_achievement_icon_size_bytes: int = Field(default=1_048_576, alias='MAX_ACHIEVEMENT_ICON_SIZE_BYTES')
    ...
    password_reset_token_ttl_hours: int = Field(default=24, alias='PASSWORD_RESET_TOKEN_TTL_HOURS')
    ...
    @property
    def achievement_upload_dir(self) -> Path:
        return self.public_upload_dir / 'achievements'
