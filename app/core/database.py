...
def _ensure_runtime_schema() -> None:
    ...
    if dialect_name.startswith('postgres') and "report_tickets" in inspector.get_table_names():
        with engine.begin() as connection:
    ...
    if dialect_name.startswith('postgres') and "report_messages" in inspector.get_table_names():
