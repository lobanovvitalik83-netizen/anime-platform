...
PERMISSION_DEFINITIONS = [
    ...
    ("achievements_manage", "Ачивки и награды"),
]
...
DEFAULT_ROLE_PERMISSIONS = {
    ...
    "admin": {"reports_view", "reports_reply", "analytics_view", "analytics_export", "import_export", "editor_tools", "team_manage", "messages_manage", "media_manage", "codes_manage", "admin_actions_view", "achievements_manage"},
