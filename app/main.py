...
# The stage24 and stage26 routers were used during earlier development stages to prototype features
# such as live chat, advanced analytics, and notifications.  These implementations were
# experimental and have since been merged into the main admin router.  To avoid duplicate
# routes and broken links in the final release, these legacy routers are no longer imported
# or included here.
...
def create_app() -> FastAPI:
    ...
    # Only include the consolidated admin router which contains all web functionality.
    # The stage24 and stage26 routers are intentionally omitted to prevent route
    # duplication and ensure that the navigation reflects the actual available pages.
