...
from app.api.routes.vk_callback import router as vk_callback_router
...
from app.web.routes.final_features import router as final_features_web_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(final_features_web_router)
